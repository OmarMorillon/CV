...
const translations = {
  es: {
    ...
    'about.p1': 'Ingeniero en Sistemas Computacionales especializado en Business Intelligence, ingeniería de datos y automatización de procesos. Cuento con experiencia comprobada en entornos corporativos exigentes como CEMEX, integrando múltiples sistemas a través de SQL Server, REST APIs y Python.',
    'about.p2': 'Tengo un perfil híbrido entre análisis de datos, BI y desarrollo full-stack. Me enfoco en recortar horas de trabajo manual mediante automatización de extremo a extremo y en construir soluciones que aporten valor real al negocio.',
    'about.fact1': 'Ing. en Sistemas Computacionales',
    'about.fact2': 'San Pedro de las Colonias, México',
    'about.fact3': 'Data Analyst @ CEMEX (Implant Soltek)',
    ...
    'exp.job1.role': 'Analista de Sistemas y Proyectos',
    'exp.job1.company': 'Implant Soltek — asignado a CEMEX',
    'exp.job1.date': 'Actualidad',
    ...
    'exp.job2.date': 'Experiencia previa',
    'exp.job2.d1': 'Business Intelligence & Logística: lideré la evolución del ecosistema de BI en Power BI (DAX, Power Query) con mapas de calor, análisis de presupuesto vs. ventas y modelos predictivos; integré trazabilidad logística completa (seguimiento de remolques y tractocamiones por viaje).',
    ...
    'exp.job2.d3': 'Desarrollo full-stack de CRM: rediseñé toda la arquitectura del CRM web corporativo, con backend en Node.js y Python.',
    ...
    'exp.cert.1': 'Google Cloud Computing Foundations',
    'exp.cert.2': 'Professional Docker Course',
    'exp.cert.3': 'HackMTY — participante (x2)',
  ...
  en: {
    ...
    'about.p1': 'Computer Systems Engineer specializing in Business Intelligence, data engineering and process automation. I have proven experience in demanding corporate environments such as CEMEX, integrating multiple systems through SQL Server, REST APIs and Python.',
    'about.p2': 'I have a hybrid profile across data analysis, BI and full-stack development. I focus on cutting hours of manual work through end-to-end automation and on building solutions that deliver real business value.',
    ...
    'exp.job1.role': 'Systems & Projects Analyst',
    'exp.job1.company': 'Implant Soltek — assigned to CEMEX',
    'exp.job1.date': 'Present',
    ...
    'exp.job2.date': 'Previous experience',
    'exp.job2.d1': 'Business Intelligence & Logistics: led the evolution of the BI ecosystem in Power BI (DAX, Power Query) with heatmaps, budget-vs-sales analysis and predictive models; integrated full logistics traceability (tracking trailers and tractor units per trip).',
    ...
    'exp.job2.d3': 'Full-stack CRM development: redesigned the entire architecture of the corporate web CRM, with a Node.js and Python backend.',
    ...
    'exp.cert.1': 'Google Cloud Computing Foundations',
    'exp.cert.2': 'Professional Docker Course',
    'exp.cert.3': 'HackMTY — participant (x2)',
    'skills.tag': '// skills',
